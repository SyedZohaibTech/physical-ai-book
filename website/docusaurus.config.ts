...
const config: Config = {
  ...
  tagline: 'An Open-Source Textbook on Modern Robotics and Embodied AI',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} The Physical AI Book Authors. Built with Docusaurus.`,
    },
    prism: {
